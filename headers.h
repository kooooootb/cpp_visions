...
constexpr static float epsilon = 0.19;//very small number
...
constexpr static float PICKUPRADIUSSQR = 20 * 20;
constexpr static float BULLETSPEED = 10;

//level save file
const static std::string levelFname = "level1.bin";
...
const static std::string texturesDirectory = "textures\\";
const static std::vector<std::string> availableWeapons = { "ak47" , "m4" };
const static std::string projectileSprite = "ak47.png";
...
const static std::vector<std::string> argWeaponNames = {"ammo" , "damage", "bullet speed"};
